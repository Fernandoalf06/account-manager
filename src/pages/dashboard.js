    ...
    <div class="card account-card account-card--${statusClass} animate-in" style="animation-delay:${idx * 0.08}s" data-account-id="${account.id}">
      ...
      <div class="btn-row">
        ...
        ` : session ? `
          ...
          ` : `
            <button class="btn btn-warning btn-join-queue" data-account-id="${account.id}">
          ...
          `}
        ` : `
          <button class="btn btn-success btn-checkin" data-account-id="${account.id}" data-account-name="${escapedAccName}">
